...
puts "Which line will you end on? (Red, Green, or Orange)"
...
def commute(mbta_lines, line1, stop1, line2, stop2)
  if line1 == line2
    no_transfer(mbta_lines, line1, stop1, stop2)
  else
    stops_on_line1 = mbta_lines[line1.to_sym].index(stop1) - mbta_lines[line1.to_sym].index("park street")
    stops_on_line2 = mbta_lines[line2.to_sym].index(stop2) - mbta_lines[line2.to_sym].index("park street")
    puts stops_on_line1.abs + stops_on_line2.abs
  end
end

puts "This is how many stops long your commute will be: "
commute(mbta_lines, first_line, first_station, second_line, second_station)
