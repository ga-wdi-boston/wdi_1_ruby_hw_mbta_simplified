...
if o_line == d_line
  same_line_dist = (mbta_lines[o_line].index(o_stop) - mbta_lines[o_line].index(d_stop)).abs
...
if o_line != d_line
  ...
  other_line_dist = (mbta_lines[d_line].index(meet_point) - mbta_lines[d_line].index(d_stop)).abs
